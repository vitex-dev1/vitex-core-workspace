...
class UsersController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // Only set when request
        if ($request->has('is_admin')) {
            $model->is_admin = $request->get('is_admin');
        }
    ...
    {
        $model = User::find($id);
        return view("ContentManager::user.update",['model' => $model]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect(Admin::route('contentManager.user.show', ['user' => $id]));
    }
