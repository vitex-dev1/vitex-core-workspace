        ...
        <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
          ...
          <ul class="list-unstyled user_data">
            ...
            <li class="m-top-xs">
              ...
              <a href="https://www.priceless-it.be" target="_blank">www.priceless-it.be</a>
            </li>
          </ul>

          <a href="{{ Admin::route('contentManager.user.edit',['user'=>$model->id]) }}" class="btn btn-success"><i class="fa fa-edit m-right-xs"></i>Edit Profile</a>
          <br />
